...
const en: Dict = {
  ...
  music: {
    ...
    featured: {
      ...
      description:
        "Lead single from the new album «!3 Messages». An inner strength no one can take away. Far from home, under foreign skies — we hold the flame of the Ukrainian spirit and will not let it die.",
    },
    tracks: [
      {
...
const fr: Dict = {
  ...
  music: {
    ...
    featured: {
      ...
      description:
        "Single phare du nouvel album « !3 Messages ». Une force intérieure que personne ne peut nous prendre. Loin de chez nous, sous des cieux étrangers — nous gardons la flamme de l'esprit ukrainien et ne la laisserons pas s'éteindre.",
    },
    tracks: [
      {
        title: "Des cendres",
