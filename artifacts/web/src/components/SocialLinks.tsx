...
const socials = [
  {
    name: "Instagram",
    url: "https://www.instagram.com/gatheringofthefallen",
    icon: (
  ...
  {
    name: "TikTok",
    url: "https://www.tiktok.com/@gatheringofthefallen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "YouTube",
    url: "https://www.youtube.com/@gathering-of-the-fallen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/share/1BJU7ec7ft/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const streaming = [
  {
    name: "Spotify",
    url: "https://open.spotify.com/artist/gatheringofthefallen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Apple Music",
    url: "https://music.apple.com/artist/gatheringofthefallen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Shazam",
    url: "https://www.shazam.com/artist/gatheringofthefallen",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0zm6.25 8.768l-8.59 8.59c-.195.195-.451.293-.707.293-.256 0-.512-.098-.707-.293-.39-.39-.39-1.023 0-1.414l8.59-8.59c.39-.39 1.023-.39 1.414 0 .39.39.39 1.024 0 1.414zm-2.535 1.414l-5.656 5.656c-.195.195-.451.293-.707.293-.256 0-.512-.098-.707-.293-.39-.39-.39-1.023 0-1.414l5.656-5.656c.39-.39 1.024-.39 1.414 0 .39.39.39 1.024 0 1.414z"/>
      </svg>
    ),
  },
];
